...
![Visualization of model-choosing process from tidymodels website](tidymodels/modeling-process.png)
...
![The tidymodels mapping of prediction types and column names](tidymodels/tidymodels_columns.png){width=50%}
&nbsp;
...
![Model equation](tidymodels/model_equation.png){width=50%}
...
![Correct mental model of where model estimation occurs in the data analysis process.](tidymodels/model_workflow.png){width=50%}
...
![Data splitting scheme from the initial data split to resampling.](tidymodels/resampling_methods.png)
...
![V-fold cross-validation data usage.](tidymodels/cross_validation.png)
...
![Bootstrapping data usage.](tidymodels/bootstrap.png)
Example code:
...
![Data usage for rolling forecasting origin resampling.](tidymodels/rolling_forecasting.png)
